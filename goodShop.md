...
0. установить `miragejs` / `@faker-js/faker` / `yup` / `jsonwebtoken`  / `lodash.orderby`, скорпировать файл [server.js](https://github.com/fetchMachine/tms-js-pro/blob/feature/goods_final_hm/hms/misc/server_shop.js) с моками бека  себе в проект и импортировать в src/index
